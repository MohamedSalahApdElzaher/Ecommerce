                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        <div class="hover">
                            ...
                            <a class="button button-account" href="{{route('seller_login_from')}}">Login Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login_form_inner register_form_inner">
                        ...
                        <form class="row login_form" action="{{route('seller.register.create')}}" method="POST" id="register_form" >
                            @csrf
